 ...
 */
var _hsq = _hsq || [];
_hsq.push(['setPortalId', 21903375]);
...
_hsq.push(['addHashedCookieDomain', '17553446']);
_hsq.push(['addHashedCookieDomain', '118747542']);
_hsq.push(['enableAutomaticLinker', true]);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/21903375.js', 'hs-script-loader']);
...
(function() {
    ...
    hstc.utils.resolveInitialUrl = function(t) {
        var e = window.location.origin
          , i = "__hsInitialUrl"
          , n = window[i] && "string" == typeof window[i] && hstc.utils.parseURL(window[i], e)
          , r = t && hstc.utils.parseURL(t, e);
        if (n && n.search && r) {
            var s = n.searchParams
              , o = r.searchParams;
            s.forEach(( (t, e) => {
                o.has(e) || o.set(e, t)
            }
            ));
            t = /^https?:\/\//.test(t) ? r.toString() : r.pathname + r.search + (r.hash || n.hash || "")
        }
        return t
    }
    ;
    ...
    var CLICKABLE_NODES = ["A", "BUTTON"]
      , CLICKABLE_ROLES = ["button", "link", "menuitem", "option", "tab"]
      , QUERY_SELECTORS = ["input[type=submit],input[type=reset],input[type=button]", CLICKABLE_NODES.join(","), ["[role=", CLICKABLE_ROLES.join("],[role="), "]"].join("")].join(",")
    ...
    hstc.autotrack.initClickListeners = function(t) {
        function e() {
            ...
            document.body.querySelectorAll(QUERY_SELECTORS).forEach((function(t) {
                "function" == typeof t.checkVisibility && VISIBILITY_STATE.set(t, t.checkVisibility(VISIBILITY_OPTIONS))
            }
            ))
        }
    ...
    hstc.autotrack.addClickListeners_ = function(t, e) {
        var i = window.matchMedia("(pointer: coarse)").matches
          , n = i ? "touchstart" : "mousedown";
        function r(t) {
            var s = t.currentTarget || t.target
              , o = hstc.autotrack.getSelector_(s);
            if (o && !TRACKED_ELEMENTS.has(o)) {
                TRACKED_ELEMENTS.add(o);
                e({
                    ...hstc.autotrack.getElementProperties_(s),
                    ...hstc.autotrack.getWindowProperties_(),
                    ...hstc.autotrack.getEventProperties_(t),
                    hs_touch_screen: i,
                    hs_selector: o,
                    hs_is_navigation: hstc.autotrack.isNavElement_(s)
                });
        ...
        t.matches && t.matches(QUERY_SELECTORS) && t.addEventListener(n, r, s)
    }
    ;
    hstc.autotrack.addMutationObserver_ = function(t, e) {
        new MutationObserver((function(t) {
            for (const i of t)
                "childList" === i.type && i.addedNodes.length > 0 && i.addedNodes.forEach((function(t) {
                    t.nodeType === Node.ELEMENT_NODE && hstc.autotrack.addClickListeners_(t, e)
                }
                ))
        }
        )).observe(t, {
    ...
    hstc.autotrack.getElementText_ = function(t) {
        var e = t.dataset
          , i = (t.innerText && t.innerText.trim() || t.alt || t.title || t.placeholder || t.ariaPlaceholder || t.ariaLabel || t.name || t.type || e && (e.label || e.title || e.text) || "title" === t.nodeName && t.textContent || t.classList.value || "").trim();
        if (!i && t.firstElementChild)
            return hstc.autotrack.getElementText_(t.firstElementChild);
        i || "IMG" !== t.tagName || (i = t.src.split(/[?#]/)[0].split("/").pop());
        return i.slice(0, 100)
    }
    ;
    ...
    hstc.autotrack.isNavElement_ = function(t) {
        if (t && t.closest) {
            if (t.closest(NAV_CONTAINERS.join(", ")))
                return !0;
            if (t.closest(NAV_ROLES.map((function(t) {
                return `[role="${t}"]`
            }
            )).join(", ")))
                return !0;
            if (NAV_TERMS.some((function(e) {
    ...
    hstc.tracking.Tracker.prototype._initAutoCapture = function() {
        if (this.hasTrackingGate("AnalyticsTracking:AutocaptureClicks")) {
            var t = this;
            hstc.autotrack.initClickListeners((function(e) {
                t.trackClickEvent({
                    properties: e
                })
            }
    ...
    hstc.tracking.Tracker.prototype._getUserInfo = function() {
        ...
        if (this.identity) {
            ...
            if ("object" == typeof i) {
                ...
                hstc.utils.logError("Identity is not a supported object: <" + i + ">", this._determineTrackingDomain())
        }
    ...
    hstc.tracking.Tracker.prototype._getPageInfo = function() {
        ...
        if (!hstc.utils.isEmpty(this.path)) {
            t.po = this.path;
            if ((this.session || hstc.tracking.Session.parse(this.cookie)).viewCount <= 1) {
        ...
        if (!hstc.utils.isEmpty(this.contentMetadata)) {
            var i = this.contentMetadata;
            hstc.utils.isEmpty(i.contentPageId) || (t.cpi = i.contentPageId);
            hstc.utils.isEmpty(i.contentGroupId) || (t.cgi = i.contentGroupId);
            hstc.utils.isEmpty(i.contentFolderId) || (t.cfi = i.contentFolderId);
            hstc.utils.isEmpty(i.legacyPageId) || (t.lpi = i.legacyPageId);
            hstc.utils.isEmpty(i.abTestId) || (t.abi = i.abTestId);
            hstc.utils.isEmpty(i.languageVariantId) || (t.lvi = i.languageVariantId);
            hstc.utils.isEmpty(i.languageCode) || (t.lvc = i.languageCode);
            if (!hstc.utils.isEmpty(i.mabData) && !hstc.utils.isEmpty(i.mabData.correlationId) && !hstc.utils.isEmpty(i.mabData.experimentId)) {
                t.mabci = i.mabData.correlationId;
                t.mabei = i.mabData.experimentId
            }
            hstc.utils.isEmpty(i.scpContentType) || (t.scpct = i.scpContentType);
            hstc.utils.isEmpty(i.inChatView) || (t.icv = i.inChatView)
        }
        if (hstc.utils.isArray(this.targetedContentMetadata) && this.targetedContentMetadata.length) {
            for (var n = [], r = Math.min(this.targetedContentMetadata.length, 5), s = 0; s < r; s++) {
                var o = this.targetedContentMetadata[s];
                3 === o.length && n.push(o[0] + "-" + o[1] + "-" + o[2])
            }
            n.length && (t.tc = n)
        }
        var c = this.context.getReferrer();
        hstc.utils.isEmpty(c) || (t.r = c);
        var a = this.context.getLocation().href;
        hstc.utils.isEmpty(a) || (t.pu = a);
        var h = this.context.getDocument().title;
        hstc.utils.isEmpty(h) || (t.t = h);
        return t
    }
    ;
    ...
    hstc.tracking.Tracker.prototype.initEventVisualizerScript = function() {
        const t = "eventVisualizerIsLocal"
          ...
          , i = "hubspotEventLabelerMode"
          , n = "true"
          , r = "hs-events-builder"
          , s = this.context.getReferrer()
          , o = "hsExchangeCredentials";
        try {
            const c = localStorage.getItem(e) === n
              , a = localStorage.getItem(i) === n
              , h = localStorage.getItem(t) === n
              , u = () => {
                if (!document.getElementById(r)) {
                    ...
                    if (i) {
                        ...
                        t.id = r;
                        t.src = `https://${n}${e}.${s}.com/events-visualizer.js`;
                        t.async = !0;
            ...
            this.eventBuilderMessageHandler = t => {
                ...
                if (hstc.utils.isValidHubUrl(i) || h) {
                    const t = e?.message;
                    t === o && u()
                }
            }
            ...
            (hstc.utils.isValidHubUrl(s) || c || a) && u()
        } catch (t) {
    ...
    ;
    !function(t) {
        var e, i, n, r, s, o, c, a, h, u, l, p, d, g, f, k, m, y = "sizzle" + -new Date, v = t.document, _ = 0, C = 0, T = rt(), w = rt(), E = rt(), S = !1, b = function(t, e) {
            if (t === e) {
                S = !0;
                return 0
            }
            return 0
        }, x = "undefined", I = 1 << 31, L = {}.hasOwnProperty, D = [], N = D.pop, A = D.push, O = D.push, P = D.slice, R = D.indexOf || function(t) {
            for (var e = 0, i = this.length; e < i; e++)
                if (this[e] === t)
                    return e;
            return -1
        }
        , U = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", j = H.replace("w", "w#"), q = "\\[" + M + "*(" + H + ")" + M + "*(?:([*^$|!~]?=)" + M + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + j + ")|)|)" + M + "*\\]", V = ":(" + H + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + q.replace(3, 8) + ")*)|.*)\\)|)", B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), F = new RegExp("^" + M + "*," + M + "*"), K = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), $ = new RegExp(M + "*[+~]"), z = new RegExp("=" + M + "*([^\\]'\"]*)" + M + "*\\]","g"), W = new RegExp(V), Y = new RegExp("^" + j + "$"), G = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
        ...
        try {
            O.apply(D = P.call(v.childNodes), v.childNodes);
            ...
            if (d && !r) {
                ...
                if (i.qsa && (!g || !g.test(t))) {
                    ...
                    if (1 === a && "object" !== e.nodeName.toLowerCase()) {
                        p = dt(t);
                        (f = e.getAttribute("id")) ? k = f.replace(tt, "\\$&") : e.setAttribute("id", k);
                        k = "[id='" + k + "'] ";
                        h = p.length;
                        for (; h--; )
                            p[h] = k + gt(p[h]);
                        _ = $.test(t) && e.parentNode || e;
                        C = p.join(",")
                    }
                    if (C)
                        try {
                            O.apply(n, _.querySelectorAll(C));
                            return n
                        } catch (t) {} finally {
        ...
        u = nt.setDocument = function(t) {
            ...
            r.find.CLASS = i.getElementsByClassName && function(t, e) {
                if (typeof e.getElementsByClassName !== x && d)
            ...
            if (i.qsa = X.test(e.querySelectorAll)) {
                ot((function(t) {
                    ...
                    t.querySelectorAll("[selected]").length || g.push("\\[" + M + "*(?:value|" + U + ")");
                ...
                ot((function(t) {
                    ...
                    t.querySelectorAll("[t^='']").length && g.push("[*^$]=" + M + "*(?:''|\"\")");
            ...
            ;
            b = p.compareDocumentPosition ? function(t, n) {
                if (t === n) {
                    S = !0;
                    return 0
                }
        ...
        nt.matchesSelector = function(t, e) {
            ...
            e = e.replace(z, "='$1']");
            if (i.matchesSelector && d && (!f || !f.test(e)) && (!g || !g.test(e)))
                try {
                    var n = k.call(t, e);
        ...
        nt.attr = function(t, e) {
            ...
            var n = r.attrHandle[e.toLowerCase()]
              , s = n && L.call(r.attrHandle, e.toLowerCase()) ? n(t, e, !d) : void 0;
            return void 0 === s ? i.attributes || !d ? t.getAttribute(e) : (s = t.getAttributeNode(e)) && s.specified ? s.value : null : s
        }
        ;
        nt.error = function(t) {
        ...
        r = nt.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    ...
                    if (t[3] && void 0 !== t[4])
                        t[2] = t[4];
                    else if (i && W.test(i) && (e = dt(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length)) {
                        t[0] = t[0].slice(0, e);
                        t[2] = i.slice(0, e)
                    }
                    return t.slice(0, 3)
            ...
            filter: {
                ...
                CHILD: function(t, e, i, n, r) {
                    ...
                    : function(e, i, a) {
                        var h, u, l, p, d, g, f = s !== o ? "nextSibling" : "previousSibling", k = e.parentNode, m = c && e.nodeName.toLowerCase(), v = !a && !c;
                        if (k) {
                            if (s) {
                                for (; f; ) {
                                    l = e;
                            ...
                            g = [o ? k.firstChild : k.lastChild];
                            if (o && v) {
                                d = (h = (u = k[y] || (k[y] = {}))[t] || [])[0] === _ && h[1];
                                p = h[0] === _ && h[2];
                                l = d && k.childNodes[d];
            ...
            pseudos: {
                ...
                lang: st((function(t) {
                    Y.test(t || "") || nt.error("unsupported lang: " + t);
        ...
        function yt(t, e, i, n, r, s) {
            ...
            return st((function(s, o, c, a) {
                var h, u, l, p = [], d = [], g = o.length, f = s || Ct(e || "*", c.nodeType ? [c] : c, []), k = !t || !s && e ? f : mt(f, p, t, c, a), m = i ? r || (s ? t : g || n) ? [] : o : k;
                i && i(k, m, c, a);
                if (n) {
                    h = mt(m, d);
                    n(h, [], c, a);
                ...
                if (s) {
                    if (r || t) {
                        ...
                        u = m.length;
                        for (; u--; )
                            (l = m[u]) && (h = r ? R.call(s, l) : p[u]) > -1 && (s[h] = !(o[h] = l))
                    }
                } else {
                    m = mt(m === o ? m.splice(g, m.length) : m);
        ...
        function vt(t) {
            for (var e, i, n, s = t.length, o = r.relative[t[0].type], c = o || r.relative[" "], h = o ? 1 : 0, u = ft((function(t) {
                return t === e
            }
            ), c, !0), l = ft((function(t) {
                return R.call(e, t) > -1
                ...
                if (i = r.relative[t[h].type])
                    ...
                    if ((i = r.filter[t[h].type].apply(null, t[h].matches))[y]) {
                        ...
                        for (; n < s && !r.relative[t[n].type]; n++)
                            ;
                        return yt(h > 1 && kt(p), h > 1 && gt(t.slice(0, h - 1).concat({
                            value: " " === t[h - 2].type ? "*" : ""
                        })).replace(B, "$1"), i, h < n && vt(t.slice(h, n)), n < s && vt(t = t.slice(n)), n < s && gt(t))
                    }
                    p.push(i)
                }
            return kt(p)
        ...
        function _t(t, e) {
            var i = 0
              , s = e.length > 0
              , o = t.length > 0
              , c = function(c, h, u, p, d) {
                var g, f, k, m = [], y = 0, v = "0", C = c && [], T = null != d, w = a, E = c || o && r.find.TAG("*", d && h.parentNode || h), S = _ += null == w ? 1 : Math.random() || .1, b = E.length;
                if (T) {
                    a = h !== l && h;
                    n = i
                }
                for (; v !== b && null != (g = E[v]); v++) {
                    if (o && g) {
                        f = 0;
                        for (; k = t[f++]; )
                            if (k(g, h, u)) {
        ...
        function Tt(t, e, n, s) {
            var o, a, h, u, l, p = dt(t);
            if (!s && 1 === p.length) {
                if ((a = p[0] = p[0].slice(0)).length > 2 && "ID" === (h = a[0]).type && i.getById && 9 === e.nodeType && d && r.relative[a[1].type]) {
                    if (!(e = (r.find.ID(h.matches[0].replace(et, it), e) || [])[0]))
                        return n;
                    t = t.slice(a.shift().value.length)
                }
                o = G.needsContext.test(t) ? 0 : a.length;
                for (; o--; ) {
                    h = a[o];
    ...
    (hstc = hstc || {}).unsizzle = function() {
        ...
        const n = {
            userInteractionClasses: new RegExp("^" + ["((is|has)-?)?(enable|disable|collapse|require|close)d?", "((is|has)-?)?(expand|select|visit|check|focus|press)(ed)?", "((is|has)-?)?(active|hidden|open|(in)?(visible|valid)|optional|read-only)", "(hover|target|outline|show|hide|autofill|sfhover)", "((is|has)-?)?(fade|slide|zoom|bounce|flip)-(in|out|up|down|left|right)", "(aria|sr)-(expanded|selected|checked|pressed|current|hidden|live)", "(hover|focus|focus-within|focus-visible|active|target):[\\w-]+", "(visited|disabled|enabled|empty|open|closed):[\\w-]+", "(btn|form|nav|dropdown|modal|tooltip|popover)-(active|disabled|focus|hover)", "(mui|uk)-(active|checked|disabled|error|expanded|focused|required|selected)"].join("|") + "$","gi"),
            event: function(t) {
                return n.node(t.target)
            },
            node: function(t) {
                const e = [];
                let i = !0
                  , r = t;
                for (; i; ) {
                    if (r.id.length || null == r.parentElement || r.parentNode === document || "HTML" === r.parentElement.tagName) {
                        e.unshift(n.selector(r));
                        i = !1
                    } else {
                        e.unshift("> " + n.selector(r));
                        r = r.parentElement
            ...
            selector: function(t) {
                const e = n.join(t.tagName, t.id, t.classList)
                  , i = n.join(t.tagName, t.id);
                if (t.parentNode !== document && n.hasSiblings(t) && !t.id) {
                    let e = 0
                      , r = !1
                      , s = 0;
                    const o = t.parentNode && Array.from(t.parentNode.children) || [];
                    for (let i = 0; i < o.length; i++) {
                        const c = o[i];
                        c !== t && n.hasDuplicateClassLists(t, c) && !r && (r = !0);
                        c.tagName === t.tagName && (e += 1);
                        t && c === t && (s = e)
                    }
                    if (r && e > 1)
                        return i + ":nth-of-type(" + s + ")"
                }
                return e
            },
            join: function(t, e, r) {
                let s = ""
                  , o = "";
                const c = r && r.length > 0 ? n.filterUserInteractionClasses(Array.from(r || [])) : [];
                if (e.length)
                    if (-1 !== e.indexOf("hsForm")) {
                        s = '[id*="' + i(e) + '"]'
                    } else if (-1 !== c.indexOf("hs-input")) {
                        s = '[id*="' + i(e) + '"]'
                    } else
                        s = "#" + e;
                if (c.length > 0) {
                    -1 !== c.indexOf("hs-form") ? o += '[class*="hs-form"]' : o += "." + c.join(".");
                    o = o.replace(n.userInteractionClasses, "")
                }
                return t.toLowerCase() + s + o
            },
            hasDuplicateClassLists: function(t, e) {
                const i = n.filterUserInteractionClasses(Array.from(t.classList))
                  , r = n.filterUserInteractionClasses(Array.from(e.classList));
                return t.tagName === e.tagName && i.toString() === r.toString()
            },
            filterUserInteractionClasses: function(t) {
                return t.filter((function(t) {
                    return !t.match(n.userInteractionClasses)
                }
                ))
            },
            ...
            unsizzle: function(t) {
                return n.isEvent(t) ? n.event(t) : n.isNode(t) ? n.node(t) : null
            },
            getHsFormElementMatches: e,
            getFuzzyMatchUsingRegex: i
        };
        return n.unsizzle
    }();
    !function(t, e, i) {
